...
def problem2a_testing():
    ...
    #       print('Actual:  ', actual)
    #
    #  TO_DO (continued): IMPORTANT NOTE:
    #  TO_DO (continued):   The function that you are TESTING is PURPOSELY
    #  TO_DO (continued)    NOT implemented.  Do NOT implement it.  That is,
...
def sum_of_digits_of_sum_of_factors(n):
    ...
    """
    ############################################################################
    #  TO_DO (continued):  This function is PURPOSELY ** not implemented. **
    #  TO_DO (continued):  DO NOT IMPLEMENT  sum_of_digits_of_sum_of_factors.
...
#    the other functions.
# TO_DO (continued):  After you have READ this _TODO_, change its _TODO_ to DONE.
################################################################################
...
def number_of_factors(n):
    ...
    return count
    ############################################################################
    #  TO_DO (continued):  Students: Do NOT touch the above   number_of_factors
    #  TO_DO (continued)   function; CALL it as appropriate in problem(s) below.
    ############################################################################
...
def problem2b(a, b, x):
    ...
    ############################################################################
    # TO_DO (continued): IMPORTANT NOTE:
    # TO_DO (continued):   **  For full credit you must appropriately use
    # TO_DO (continued):       (i.e., call) the   number_of_factors   function
    #                         that is DEFINED ABOVE.
    ############################################################################
    total = 0
    for i in range(a, b+1):
        factor_num = number_of_factors(i)
        if factor_num >= x:
            total += i
    return total
...
def problem1c(m):
    ...
    ############################################################################
    # TO_DO (continued): IMPORTANT NOTE:
    # TO_DO (continued):   This problem is 1 point (of 100) on the exam.
    # TO_DO (continued)    Do not spend more than a few minutes on it.
    # TO_DO (continued)    You get   NO credit   if your solution is more
    # TO_DO (continued)    than 3 lines of code (and it can be done in 1 line).
    ############################################################################
